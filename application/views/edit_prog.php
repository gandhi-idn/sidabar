            ...
            <section role="main" class="content-body">
                <header class="page-header">
                    ...
                    <div class="right-wrapper pull-right">
                        <ol class="breadcrumbs">
                            ...
                            <li><span>Barang Selesai</span></li>
                        </ol>
                ...
                <div class="row">
                    <div class="text-justify">
                        <a href="<?= base_url('index.php/main/progres'); ?>"><span class="glyphicon glyphicon-arrow-left"></span> Kembali ke Progres</a>
                    </div>
